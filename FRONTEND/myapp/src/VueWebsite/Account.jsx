...
const Account = () => {
    ...
    return (
        <>
            <Box sx={{ p: 3, maxWidth: 1200, width: '100%', mx: "auto", bgcolor: "white", borderRadius: 2, boxShadow: 3 }}>
                <Stack spacing={2}>
                    <Stack direction="row" spacing={2} alignItems="center">
                        <Avatar src="/photo.png" sx={{ width: 100, height: 100, borderRadius: 2 }} />
                        <Stack direction="row" spacing={2}>
                            <Button variant="contained" sx={{ textTransform: "none", backgroundColor: '#7367f0' }}>Upload new photo</Button>
                            <Button variant="outlined" sx={{ textTransform: "none", backgroundColor: '#EBEBED' }}>Reset</Button>
                        </Stack>
                    </Stack>
                    ...
                    <Stack direction="row" gap={2}>
                        ...
                        <Button variant="outlined" sx={{ textTransform: "none", backgroundColor: '#EBEBED' }}>Cancel</Button>
                    </Stack>
                </Stack>
            </Box>
            ...
            <Paper sx={{ p: 3, mt: 5, mb: 5, maxWidth: 1200, width: '100%', height: 250, mx: "auto", bgcolor: "white", borderRadius: 2, boxShadow: 3 }}>
                <Typography variant="h6" gutterBottom sx={{mb:2}}>
                    Delete Account
                </Typography>

                <Alert severity="warning" sx={{ backgroundColor: '#fff0e1', borderColor: '#fff0e1', color: '#ff9f43', mb:2 }}>
            ...
            <Box sx={{ textAlign: "center", mt: 4 }}>
                <Typography variant="body2">© 2025, made with ❤️ by Pixinvent</Typography>
            </Box>
        </>
    );
};
